...
st.set_page_config(page_title="Recherche Zonage Dentistes")

# Titre
st.title("Recherche de zone dentaire par ville ou code postal")

# Chargement du fichier CSV
@st.cache_data
def charger_donnees():
    return pd.read_csv("CP Alex.csv", sep=';')
